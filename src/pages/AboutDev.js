      ...
      <div className="flex-1">
        ...
        <main className="p-6">
          <section className="mb-8">
            ...
            <p className="text-lg">
              Hello! I'm Shbuham kumar, a passionate and results-driven professional
              with expertise in Web Development, Data Science, Cloud & DevOps .
              Adept at crafting robust web applications, 
              deriving actionable insights from data, and streamlining cloud-based workflows. 
              Proficient in modern tools, technologies, and methodologies to deliver scalable, 
              secure, and high-performance solutions.
              Committed to continuous learning and leveraging innovative approaches 
              to solve complex technical challenges.a passionate Computer Science
